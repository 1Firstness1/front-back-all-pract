...
// Важно: эти ключи лучше хранить в .env, но оставляем как было в учебном проекте
const vapidKeys = {
...
// Подписки на push-уведомления (в памяти процесса)
let subscriptions = [];

// Запланированные напоминания (в памяти процесса)
